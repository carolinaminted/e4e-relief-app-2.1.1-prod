  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto w-full">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-[var(--theme-bg-secondary)] rounded-lg border border-[var(--theme-border)]">
        ...
        <div className="bg-[var(--theme-bg-secondary)] rounded-lg border border-[var(--theme-border)]">
            ...
            <div className={`transition-all duration-500 ease-in-out overflow-hidden ${openSection === 'view' ? 'max-h-[3000px] opacity-100 p-4 pt-0 border-t border-[var(--theme-border)]/50' : 'max-h-0 opacity-0'}`}>
                <div className="pt-4 space-y-3">
                    {tickets.length > 0 ? (
                        tickets.map(ticket => (
                            <div key={ticket.id} className="bg-[var(--theme-bg-primary)]/50 p-4 rounded-md border border-[var(--theme-border)]/30">
